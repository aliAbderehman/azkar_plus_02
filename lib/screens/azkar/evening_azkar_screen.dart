...
import 'package:azkar_plus/screens/azkar/contents/evening_azkar.dart';
...
class _EveningAzkarScreenState extends State<EveningAzkarScreen> {
  ...
  void updateZikr(String sens, bool isVibrate) {
    ...
    if (sens == '+') {
      if (index == eveningAzkar.length - 1) {
        if (azkIndex == eveningAzkar[index].counter) {
          index = 0;
      ...
      body: Column(
        children: [
          Row(
            ...
            children: [
              ...
              StatText(
                azkIndex: azkIndex,
                index: index,
                counter: eveningAzkar[index].counter,
              ),
              Expanded(
                child: Row(
          ...
          Expanded(
            flex: 4,
            child: AzkarCard(
              azkarAr: eveningAzkar[index].arabicAzkar,
              azkarAm: TranslatePrefs.getTranslateStatus()!
                  ? eveningAzkar[index].amharicTranslation
                  : '',
              counter: (index),
            ...
            child: Row(
              ...
              children: [
                ...
                SmallButton(
                  onPressed: () {
                    setState(() {
                      azkIndex = eveningAzkar[index].counter;
                      updateZikr('+', isVibrate);
                    });
                    azkIndex = 1;
                  },
